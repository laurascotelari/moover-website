...
import { MagnifyingGlass, ShoppingCart, Moon, Plus, List, X } from "phosphor-react"; 
...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center px-5 py-3 bg-black text-yellow-500 w-full">
      ...
      <nav 
        className={`lg:hidden fixed top-0 left-0 w-full h-full bg-[#B08F43] flex flex-col items-center justify-start space-y-8 text-yellow-500 z-50 transition-transform duration-500 ease-in-out ${isMenuOpen ? "translate-x-0" : "translate-x-[-100%]"}`}
      >
        ...
        <a href="#formatura" className="hover:underline text-white text-xl border-b border-white py-2 w-1/4 text-center inline-block max-w-[90%]">Formatura</a>
        <a href="#debutante" className="hover:underline text-white text-xl border-b border-white py-2 w-1/4 text-center inline-block max-w-[90%]">Debutante</a>
        <a href="#casamento" className="hover:underline text-white text-xl border-b border-white py-2 w-1/4 text-center inline-block max-w-[90%]">Casamento</a>
        <a href="#eventos" className="hover:underline text-white text-xl border-b border-white py-2 w-1/4 text-center inline-block max-w-[90%]">Eventos</a>
      </nav>
