...
import { WhatsappLogo, InstagramLogo, WarningCircle } from "@phosphor-icons/react";
    ...
    <div className="min-h-screen lg:grid lg:grid-cols-2 mt-20 font-montserrat px-4 md:px-8">
      <div className="mx-auto max-w-xl sm:max-w-full">
        <p className="text-sm text-primary-darker">
          home/
          <span className="text-md lg:text-xl font-semibold"> Vestido Fenda</span>
        </p>
      ...
      <main className="mx-auto max-w-xl">
        <div className="mt-5">
          ...
          <h1 className="text-lg lg:text-2xl font-semibold text-primary-darker mt-1">Vestido De Festa Longo com Fenda Lateral e Manga Longa </h1>
          <h2 className="text-lg lg:text-2xl font-medium text-primary-darker mt-6 lg:mt-8 ">
            R$ 350,00
            <span className="text-sm lg:text-base font-normal text-black ml-2">10x de 35,00 sem juros</span>
          </h2>

          <form action="" onSubmit={(e) => handleFormSubmit(e)}>
            <div className="space-y-6 mt-6">
              <div>
                <h2 className="text-lg lg:text-xl font-medium text-primary-darker mb-2">Cor</h2>
                <div className="flex items-center space-x-4 mt-2">
                  <label htmlFor="pink" className="cursor-pointer">
                    <input type="radio" id="pink" name="color" value="pink" className="hidden peer" />
                  ...
                  <label htmlFor="green" className="cursor-pointer">
                    <input type="radio" id="green" name="color" value="green" className="hidden peer" />
                  ...
                  <label htmlFor="orange" className="cursor-pointer">
                    <input type="radio" id="orange" name="color" value="orange" className="hidden peer" />
                  ...
                  <span id="color-error" className="flex items-center gap-2 ml-4 text-red-500 text-xs lg:text-sm font-semibold hidden">
              ...
              <div>
                <div className="flex items-center">
                  <h2 className="text-lg lg:text-xl font-medium text-primary-darker mb-2">Tamanho</h2>
                </div>
                <div className="flex space-x-4 mt-2">
                  <label htmlFor="p" className="cursor-pointer">
                    <input type="radio" id="p" name="size" value="P" className="hidden peer" />
                    <span className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-primary-darker border-2 border-gray-300 rounded-sm text-white text-sm lg:text-lg font-medium peer-checked:border-[3.5px] peer-checked:border-black">P</span>
                  </label>
                  <label htmlFor="m" className="cursor-pointer">
                    <input type="radio" id="m" name="size" value="M" className="hidden peer" />
                    <span className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-primary-darker border-2 border-gray-300 rounded-sm text-white text-sm lg:text-lg font-medium peer-checked:border-[3.5px] peer-checked:border-black">M</span>
                  </label>
                  <label htmlFor="g" className="cursor-pointer">
                    <input type="radio" id="g" name="size" value="G" className="hidden peer" />
                    <span className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-primary-darker border-2 border-gray-300 rounded-sm text-white text-sm lg:text-lg font-medium peer-checked:border-[3.5px] peer-checked:border-black">G</span>
                  </label>
                  <span id="size-error" className="flex items-center gap-2 ml-4 text-red-500 text-xs lg:text-sm font-semibold hidden">
                    <WarningCircle size={20} className="flex-shrink-0" />Selecione um tamanho.
                  </span>
                </div>
              </div>
            </div>
            ...
            <button type="submit" className="text-md lg:text-lg text-white bg-primary-darker font-medium mt-4 h-10 w-full rounded-md hover:bg-btn-hover">COMPRAR</button>
          </form>
        </div>
        ...
        <div className="mt-6 text-md">
          ...
          <h3 className="text-md lg:text-lg font-semibold text-primary-darker mt-4">Ideal para ocasiões:</h3>
          <ul className="list-disc ml-7 text-sm lg:text-lg">
          ...
          <div className="mt-5">
            <div>
              <details className="open:shadow-lg p-4 border border-black/40">
                ...
                <div className="mt-3 text-sm lg:text-md leading-6 space-y-2">
                  <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores quia, asperiores veniam deleniti sed, incidunt adipisci consectetur, eum unde facilis neque fugit optio magni a ratione est alias. Asperiores, ducimus?</p>
                </div>
              </details>
            </div>
            ...
            <div>
              <details className="open:bg-white open:ring-1 open:ring-black/5 open:shadow-lg p-4 border border-black/40">
                ...
                <div className="mt-3 text-sm lg:text-md leading-6 space-y-2">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit expedita debitis laborum error nostrum consectetur quaerat? Libero, reprehenderit iure. Quas corporis facilis nihil enim itaque maiores hic iusto suscipit asperiores?</p>
                </div>
              </details>
            </div>
            ...
            <div>
              <details className="open:bg-white open:ring-1 open:ring-black/5 open:shadow-lg p-4 border border-black/40">
                ...
                <div className="mt-3 text-sm lg:text-md leading-6 space-y-2">
                  ...
                  <p>Seu vestido não deverá ser lavado ou seco em máquina. </p>
                  <p>Recomendamos a lavagem a mão, preferencialmente com a peça ao avesso. </p>
                  <p>Secar à sombra </p>
                </div>
              </details>
            </div>
        ...
        <div className="mt-6">
          <h2 className="text-lg lg:text-xl font-medium text-primary-darker">Frete</h2>
          ...
          {!isValid && (
            <span id="cep-error" className="flex items-center gap-2 mt-4 text-red-500 text-xs lg:text-sm font-semibold">
              <WarningCircle size={20} className="flex-shrink-0" />Por favor, digite um CEP válido.
            </span>
          )}
          {showMessage && (
            <div id="cep-error" className="flex justify-between items-center gap-2 mt-4 text-sm">
        ...
        <div className="mt-5">
          ...
          <div className="flex items-center gap-7 mt-3">
            <a href="#"><InstagramLogo size={43} color="#584424" /></a>
            <a href="#"><WhatsappLogo size={43} color="#584424" /></a>
          </div>
        </div>
